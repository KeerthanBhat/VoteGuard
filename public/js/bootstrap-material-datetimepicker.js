 ...
 app.controller('dateMatCtrl', function($scope){
...
initTemplate: function ()
{
  ...
  '<button class="dtp-btn-ok btn btn-flat" id="clkok">' + this.params.okText + '</button>' +
  '<div class="clearfix"></div>' +
  '</div>' +
  '</div>' +
  '</div>';
...
_onSelectDate: function (e)
{
  ...
  console.log(" ye hai "+this.selectDate($(e.currentTarget).parent().data("date")));
  document.getElementById("dtid").innerHTML  = this.currentDate.format('DD-MM-YYYY');
  console.log("this.currentDate"+this.currentDate);
                  this._onOKClick(); //change date directly from selecting date.
...
{  
  ...
  $('#max-date').bootstrapMaterialDatePicker('setDate', new Date());
  $.material.init();
});
